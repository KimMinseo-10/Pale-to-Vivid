...
#nullable disable
public class SecondStageEND : MonoBehaviour
{
  [SerializeField]
  ...
  {
    SecondStageEND secondStageEnd = this;
    yield return (object) secondStageEnd.StartCoroutine(secondStageEnd.FadeText(0.0f, 1f, 1f));
    yield return (object) new WaitForSeconds(3f);
    yield return (object) secondStageEnd.StartCoroutine(secondStageEnd.FadeText(1f, 0.0f, 1f));
  }
