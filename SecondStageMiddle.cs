...
#nullable disable
public class SecondStageMiddle : MonoBehaviour
{
  [SerializeField]
  ...
  {
    SecondStageMiddle secondStageMiddle = this;
    yield return (object) secondStageMiddle.StartCoroutine(secondStageMiddle.FadeText(0.0f, 1f, 1f));
    yield return (object) new WaitForSeconds(3f);
    yield return (object) secondStageMiddle.StartCoroutine(secondStageMiddle.FadeText(1f, 0.0f, 1f));
  }
